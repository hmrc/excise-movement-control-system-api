...
import uk.gov.hmrc.excisemovementcontrolsystemapi.models.{EisUtils, MessageReceiptResponse, ShowNewMessageResponse}
...
class MessageReceiptConnectorSpec
  ...
  private val eisUtil = mock[EisUtils]
  private val sut = new MessageReceiptConnector(httpClient, appConfig, eisUtil, metrics)
  ...
  override def beforeEach(): Unit = {
    ...
    when(eisUtil.generateCorrelationId).thenReturn("12345")
