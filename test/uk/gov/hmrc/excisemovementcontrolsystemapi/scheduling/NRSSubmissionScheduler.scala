...
class NrsSubmissionSchedulerSpec
  ...
  val mockNrsSubmissionWorkItemRepository: NrsSubmissionWorkItemRepository = mock[NrsSubmissionWorkItemRepository]
  val mockNrsConnector                                                     = mock[NrsConnector]
  ...
  override def fakeApplication(): Application                              = GuiceApplicationBuilder()
    .overrides(
      bind[NrsSubmissionWorkItemRepository].toInstance(mockNrsSubmissionWorkItemRepository),
