...
case class PreValidateTraderETDSMessageResponse(
...
object PreValidateTraderETDSMessageResponse {
  implicit val format: Format[PreValidateTraderETDSMessageResponse] = Json.format[PreValidateTraderETDSMessageResponse]
}
