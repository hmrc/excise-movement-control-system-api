...
import uk.gov.hmrc.excisemovementcontrolsystemapi.models.{EisUtils, MessageReceiptResponse, MessageTypes}
...
(
  ...
  eisUtils: EisUtils,
  metrics: Metrics
)(implicit val ec: ExecutionContext) extends EisResponseHandler with Logging {
