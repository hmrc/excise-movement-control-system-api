...
import uk.gov.hmrc.excisemovementcontrolsystemapi.models.preValidateTrader.response.{PreValidateTraderEISResponse, PreValidateTraderETDSResponse, PreValidateTraderMessageResponse}
...
class PreValidateTraderService @Inject() (
  ...
  )(implicit hc: HeaderCarrier): Future[Either[Result, PreValidateTraderETDSResponse]] =
