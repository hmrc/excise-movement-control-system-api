...
object IE905TestMessageType extends TestMessageType {
  ...
  override def json1: JsValue = Json.parse(
    "{\"Header\":{\"MessageSender\":\"NDEA.GB\",\"MessageRecipient\":\"NDEA.XI\",\"DateOfPreparation\":\"2023-07-02\",\"TimeOfPreparation\":\"21:23:41\",\"MessageIdentifier\":\"XI00432RR\",\"CorrelationIdentifier\":\"PORTAL6de1b822562c43fb9220d236e487c920\"},\"Body\":{\"StatusResponse\":{\"AttributesValue\":{\"AdministrativeReferenceCode\":\"23XI00000000000056349\",\"SequenceNumber\":\"1\",\"Status\":\"X07\",\"LastReceivedMessageType\":\"IE881\"}}}}"
  )

  override def auditEvent: JsValue = Json.parse(
    """{"messageCode":"IE905","content":{"Header":{"MessageSender":"NDEA.GB","MessageRecipient":"NDEA.XI","DateOfPreparation":"2023-07-02","TimeOfPreparation":"21:23:41","MessageIdentifier":"XI00432RR","CorrelationIdentifier":"PORTAL6de1b822562c43fb9220d236e487c920"},"Body":{"StatusResponse":{"AttributesValue":{"AdministrativeReferenceCode":"23XI00000000000056349","SequenceNumber":"1","Status":"X07","LastReceivedMessageType":"IE881"}}}},"outcome":{"status":"SUCCESS"}}"""
  )

  override def auditFailure(failureReason: String) = Json.parse(
    s"""{"messageCode":"IE905","content":{"Header":{"MessageSender":"NDEA.GB","MessageRecipient":"NDEA.XI","DateOfPreparation":"2023-07-02","TimeOfPreparation":"21:23:41","MessageIdentifier":"XI00432RR","CorrelationIdentifier":"PORTAL6de1b822562c43fb9220d236e487c920"},"Body":{"StatusResponse":{"AttributesValue":{"AdministrativeReferenceCode":"23XI00000000000056349","SequenceNumber":"1","Status":"X07","LastReceivedMessageType":"IE881"}}}},"outcome":{"status":"FAILURE","failureReason":"$failureReason"}}"""
  )
}
