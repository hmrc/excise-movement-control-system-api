...
object IE802TestMessageType extends TestMessageType {
  ...
  override def auditEvent: JsValue = Json.parse("""{"messageCode":"IE802","content":{"Header":{"MessageSender":"CSMISE.EC","MessageRecipient":"CSMISE.EC","DateOfPreparation":"2008-09-29","TimeOfPreparation":"00:18:33","MessageIdentifier":"X00004","CorrelationIdentifier":"X00004"},"Body":{"ReminderMessageForExciseMovement":{"AttributesValue":{"DateAndTimeOfIssuanceOfReminder":"2006-08-19T18:27:14","ReminderInformation":{"value":"token","attributes":{"@language":"to"}},"LimitDateAndTime":"2009-05-16T13:42:28","ReminderMessageType":"2"},"ExciseMovement":{"AdministrativeReferenceCode":"23XI00000000000000090","SequenceNumber":"10"}}}},"outcome":{"status":"SUCCESS"}}""")

  override def auditFailure(failureReason: String): JsValue = Json.parse(s"""{"messageCode":"IE802","content":{"Header":{"MessageSender":"CSMISE.EC","MessageRecipient":"CSMISE.EC","DateOfPreparation":"2008-09-29","TimeOfPreparation":"00:18:33","MessageIdentifier":"X00004","CorrelationIdentifier":"X00004"},"Body":{"ReminderMessageForExciseMovement":{"AttributesValue":{"DateAndTimeOfIssuanceOfReminder":"2006-08-19T18:27:14","ReminderInformation":{"value":"token","attributes":{"@language":"to"}},"LimitDateAndTime":"2009-05-16T13:42:28","ReminderMessageType":"2"},"ExciseMovement":{"AdministrativeReferenceCode":"23XI00000000000000090","SequenceNumber":"10"}}}},"outcome":{"status":"FAILURE","failureReason":"$failureReason"}}""")
}
