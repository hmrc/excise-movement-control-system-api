...
object IE704TestMessageType extends TestMessageType {
  ...
  override def auditEvent: JsValue = Json.parse("""{"messageCode":"IE704","content":{"Header":{"MessageSender":"NDEA.XI","MessageRecipient":"NDEA.XI","DateOfPreparation":"2008-09-29","TimeOfPreparation":"00:18:33","MessageIdentifier":"XI000001","CorrelationIdentifier":"9b8effe4-adca-4431-bfc2-d65bb5f1e15d"},"Body":{"GenericRefusalMessage":{"AttributesValue":{"AdministrativeReferenceCode":"23XI00000000000000012","SequenceNumber":"1","LocalReferenceNumber":"lrnie8158976912"},"FunctionalError":[{"ErrorType":"4401","ErrorReason":"token","ErrorLocation":"token","OriginalAttributeValue":"token"}]}}},"outcome":{"status":"SUCCESS"}}""")

  override def auditFailure(failureReason: String): JsValue = Json.parse(s"""{"messageCode":"IE704","content":{"Header":{"MessageSender":"NDEA.XI","MessageRecipient":"NDEA.XI","DateOfPreparation":"2008-09-29","TimeOfPreparation":"00:18:33","MessageIdentifier":"XI000001","CorrelationIdentifier":"9b8effe4-adca-4431-bfc2-d65bb5f1e15d"},"Body":{"GenericRefusalMessage":{"AttributesValue":{"AdministrativeReferenceCode":"23XI00000000000000012","SequenceNumber":"1","LocalReferenceNumber":"lrnie8158976912"},"FunctionalError":[{"ErrorType":"4401","ErrorReason":"token","ErrorLocation":"token","OriginalAttributeValue":"token"}]}}},"outcome":{"status":"FAILURE","failureReason":"$failureReason"}}""")
}
